...
class SalesExecutive(Employee):
    target = 1500000
    _position = "Sales Executive"       # protected
    __feedback = 3                         # private
    ...
    def _updateTarget(self):
        self.target = int(input('Enter new target: '))

    def __updateFeedback(self):
        self.__feedback = float(input('Enter new feedback ratings: '))
...
s1 = SalesExecutive('Python', 32, 'M', 'Ahmedabad')
s1._position = 'Sales Manager'
print(s1._position)
# print(s1.__feedback)
# Name Mangling
s1._SalesExecutive__updateFeedback()
print(s1._SalesExecutive__feedback)
